.. meta::
   :description: How to use Axe cryptocurrency with hardware wallets
   :keywords: axe, hardware, wallet, ledger, keepkey, trezor, secure, private key

.. _axe-hardware-wallet:
...
exist, with Axe supported on all of them.
...
supported Axe since January 2017 with the release of firmware version
1.4.2.
...
- Review: https://www.axeforcenews.com/trezor-hardware-wallet-review
- Shop: https://shop.trezor.io
- Wallet: https://wallet.trezor.io

It is also possible to operate a Axe masternode using your Trezor. See
here for details.
...
wallet to use it with. Trezor supports the following Axe wallets:

- `Trezor Wallet <https://wallet.trezor.io>`_ (`documentation
  <https://doc.satoshilabs.com/trezor-apps/trezorwallet.html>`__)
- `Axe Electrum Wallet <https://electrum.docs.axerunners.com>`__
  (:ref:`documentation <axe-electrum-wallet>`)
- `Axe Masternode Tool <https://github.com/Bertrand256/axe-masternode-
  tool>`_ (`documentation <https://github.com/Bertrand256/axe-
...
#. Switch to the Axe wallet using the menu at the top left. You can now
   use your Trezor to send and receive Axe.

.. figure:: img/trezor-start.png
   :width: 400px

   Trezor Web Wallet for Axe ready for first use

Receiving Axe
--------------

We will now create a Axe receiving address and attempt to receive 1.0
AXE.

1. In the Trezor Axe wallet, click **Account #1**, then click Receive. 
2. A Axe address will appear. Click **Show full address** to verify the
   address on the Trezor device.

  .. image:: img/trezor-address.jpg
     :width: 100px

3. Send 1 AXE to this address using an exchange or another wallet.
...
.. figure:: img/trezor-receive.png
   ...
   Trezor Web Wallet after receiving Axe


Sending Axe
------------

We will now send the Axe (minus transaction costs) to an external
address.

1. In the Trezor Axe wallet, click **Account #1**, then click **Send**.
2. Enter the Axe address and amount in the fields.
...
.. figure:: img/trezor-balance.png
   ...
   Trezor Web Wallet after sending Axe
...
/axe-masternode-tool/releases>`_.
...
A few sample images are available for Axe:
...
can be damaged by pressure or water, for example. For this reason, Axe
...
has supported Axe since firmware version 4.2.10, released on March 28,
...
It is also possible to operate a Axe masternode using your KeepKey. See
here for details.
...
supported Axe since November 2016 and firmware version 1.2. Follow
`these instructions
<http://support.ledgerwallet.com/knowledge_base/topics/how-to-use-axe-
with-a-nano-s>`_ to add Axe support to the device.

- Site: https://www.ledgerwallet.com
- Review: https://www.axeforcenews.com/ledger-nano-s-review
...
It is also possible to operate a Axe masternode using your Ledger. See
here for details.
