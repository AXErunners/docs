...
.. image:: img/axe_logo.png
   :width: 60 %
   :align: center

Axe is an open source peer-to-peer cryptocurrency with a strong focus
on the payments industry. Axe offers a form of money that is portable,
...
project, Axe aims to be the most user-friendly and scalable payments
system in the world. In addition to Bitcoin's feature set, Axe
...
self-funding model that enables the Axe network to pay individuals and
