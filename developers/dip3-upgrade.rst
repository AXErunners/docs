.. meta::
   :description: The upgrade to Axe 0.13.0 involves changes to signature formats as defined in DIP3. This documentation highlights the upgrade steps and progress.
...
**Official binaries are available at** https://github.com/axerunners/axe/releases/tag/v0.13.0.0

Axe Core v0.13.0 is intended to serve as the foundation for Axe
...
Core v0.13.0 Product Brief <https://blog.docs.axerunners.com/product-brief-axe-core-release-v0-13-0-5d7fddffb7ef>`__ 
...
Axe Core v0.13.0.0 will automatically activate `DIP002
...
Please note that Axe Core v0.13.0.0 requires a one-time upgrade to all
...
- Please refer to the `Transaction Type Integration Guide <https://github.com/axerunners/docs/raw/master/binary/merchants/Integration-Resources-Axe-v0.13.0-Transaction-Types.pdf>`__ 
...
Please see the official `Release Notes <https://github.com/axerunners/axe/blob/v0.13.0.0/doc/release-notes.md#rpc-changes>`__ 
