...
**Official binaries are available at** https://github.com/axerunners/axe/releases/tag/v1.2.0.0
...
Please see the official `Release Notes <https://github.com/axerunners/axe/blob/v1.2.0.0/doc/release-notes.md#rpc-changes>`__ 
