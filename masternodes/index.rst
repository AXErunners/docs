.. meta::
   :description: Introduction to documentation on how to set up and operate a masternode for the Axe cryptocurrency.
   :keywords: axe, masternodes, hosting, linux, payment, setup
...
Axe is best known as the first cryptocurrency with a focus on anonymity
...
Axe network through a monthly budget and voting. This in itself is a 
first in the crypto world, and the masternodes are necessary to achieve
the privacy and speed that Axe offers.
...
masternode on the Axe network is 1000 AXE. This is known as the
collateral, and cannot be spent without interrupting operation of the
masternode. The second requirement is the actual server running the Axe
masternode software.
...
workings of the Axe network may choose to operate their own masternode
