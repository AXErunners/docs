.. meta::
   :description: How to prepare and submit a successful proposal for the Axe treasury system
   :keywords: axe, treasury, proposal, recommendations, communication, escrow
...
Proposals in the Axe governance system are subject to voting by
...
Keep your proposal clear
  ...
  exactly how it will benefit the Axe network, how much Axe you are
...
Run a pre-proposal discussion
  ...
  <https://www.axerunners.com/forum/topic/pre-budget-proposal-
  discussions.93>`__ and `Axe Nation Discord <http://axechat.org>`__,
  and `Reddit <https://www.reddit.com/r/axerunners>`__ also attracts a lot
...
Manage your identity and reputation
  The Axe community is one of the network's strongest features, and
...
Run an enthusiastic campaign for your proposal
  ...
  <https://www.axerunners.com/forum/topic/pre-budget-proposal-
  discussions.93>`_ and `AxeCentral
  <https://www.axecentral.org/budget>`_, become a regular on Discord
  ...
  involvement with Axe - but don't be annoying and spam many channels
  asking for votes.

Demonstrate your commitment to the network
  If you are asking for significant funding to start up or expand a
  for-profit business built on Axe, you need to explain why and for how
  ...
  contribution provided in Axe with funds from your own business or
  investors. Equity or exclusivity agreements can be reached with `Axe
  Core Group, Inc. <bradley.zastrow@docs.axerunners.com>`_, but must be clarified
...
Post your proposal early and make yourself available for questions
  ...
  once it appears on the blockchain or when you claim it on AxeCentral.
...
Consider arrangements for large requests
  ...
  network. Reach out to trusted intermediaries such as `Axe Core Group,
  Inc. <bradley.zastrow@docs.axerunners.com>`_ or `Green Candle, Inc.
...
B. Johnson's extremely popular **AXE: Detailed** proposal:
...
#. To avoid accusations of favouritism and inside trading, Axe Core
...
#. If your proposal is for news, promotion or marketing, make sure you
   ...
   Axe Force News or marketing firms contracted by Axe Core.
...
#. You are responsible for your own planning to hedge against price
   ...
   parties in fiat currency, reach out to `Axe Core Group, Inc.
   <bradley.zastrow@docs.axerunners.com>`_ or `Green Candle, Inc.
