.. meta::
   :description: Discussion of theory and motivation behind the Axe governance system and treasury
   :keywords: axe, dgbb, governance, funding, voting, blockchain, development, block reward, treasury, budget

.. _understanding-governance:

=============================
Understanding Axe Governance
=============================
...
Through the network of full nodes and the collateral requirement, Axe
...
success of Axe, but they are the most stable ones because, unlike
...
blockchain to the person doing the work. This allows Axe to hire core
...
implementation of the Axe roadmap and core Axe services.
...
<https://www.axerunners.com/forum/topic/pre-budget-proposal-discussions.93/>`_
on the Axe Forum, where feedback and suggestions are solicited from the
...
governance object on the blockchain. A fee of 5 AXE is associated with
...
same process is then repeated every month, and the total amount of Axe
...
The community has gathered around `AxeCentral
<https://www.axecentral.org>`__ as a website to facilitate discussion
and voting on proposals formally entered on the Axe blockchain. Other
websites, such as `Axe Ninja <https://www.axeninja.pl>`__ and `Axe
Nexus <https://axenexus.org>`__ are available to monitor progress over
time and gather more detailed statistics. `Axe Masternode Tool
<https://github.com/Bertrand256/axe-masternode-tool/releases>`__ also
allows for voting without the need to share masternode private keys with
a third party service.

.. figure:: img/governance-axecentral.png
   :width: 400px

   A typical view of proposal discussion and voting on Axe Central
...
proposal owner. Discussion on Axe Central occurs below this
...
.. figure:: img/governance-axecentral-vote.png
   :width: 400px

   Proposal details and voting buttons on Axe Central

Once passed, proposals are able to report back to the network on the
`Axe Forum <https://www.axerunners.com/forum/topic/approved-proposals-
...
by Axe in cache files, so current winning proposals and the total
allocation of the available budget are always open and visible to
everyone. `Axe Nexus <https://axenexus.org>`__ is a popular site used
for to view progress on proposal voting.

.. figure:: img/governance-axenexus.png
   :width: 400px

   Monitoring budget allocation on Axe Nexus

Finally, `Axe Watch <http://axewatch.org>`__ (which was itself funded
...
performance of your proposal to Axe Watch is optional, many masternode
owners take advantage of the data they make available to make their
voting decisions. The Axe Watch team may be contacted at
team@axewatch.org email address or through their `website
<http://axewatch.org>`__.

.. figure:: img/governance-axewatch.png
   :width: 400px

   Proposal monitoring on Axe Watch
...
smaller decentralized projects, according to current needs. Axe Core
Group, Inc. is one example of such an organization.

The existence of the decentralized budget system puts the power of
determining where Axe goes in the future in the hands of the masternode
...
developers, making Axe the first blockchain designed to outlive its
