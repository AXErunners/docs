.. meta::
   :description: Information and guides on how to mine the Axe cryptocurrency
   :keywords: axe, mining, X11, masternode, CPU, GPU, ASIC, software, hardware, pool, mining pools
...
Mining in the context of cryptocurrency such as Axe refers to the
...
is possible on a range of hardware. Axe implements an algorithm known
...
secure against brute force attacks on the Axe blockchain.
...
- `Hashrate <https://bitinfocharts.com/comparison/axe-hashrate.html>`_
- `Mining difficulty <https://bitinfocharts.com/comparison/axe-difficulty.html>`_
- `Profitability calculation tool <https://www.coinwarz.com/calculators/axe-mining-calculator>`_
...
Axe and Bitcoin, the consensus mechanism is Proof of Work (PoW). Miners
...
Mining Axe in pools is more likely to generate rewards than solo mining
directly on the blockchain. Mining axe using P2Pool is strongly
encouraged, since it is a good way to distribute, rather than
centralize, the hashing power. The following site lists Axe P2Pool
mining pools near you, simply choose a pool with favourable fees and
ping time and enter your Axe payment address as username and anything
as password.

- http://www.p2poolmining.us/p2poolnodes/

If you would like to set up your own P2Pool, documentation of the
process is available :ref:`here <p2pool>` and the code for p2pool-axe
is available on `GitHub <https://github.com/axerunners/p2pool-axe>`_.
...
- https://axe.suprnova.cc
- https://www.nicehash.com
- https://www.coinotron.com
- https://axe.miningpoolhub.com
- https://www.multipool.us
- https://axe.miningfield.com
- https://www.f2pool.com
- https://axe.miningfield.com
- https://www2.coinmine.pl/axe
- https://aikapool.com/axe
- https://www.antpool.com
- https://avalon-life.io
- https://www.genesis-mining.com
- https://pool.viabtc.com/pool/axe/state
- http://axe.cybtc.info
- http://zpool.ca

DISCLAIMER: This list is provided for informational purposes only.
Services listed here have not been evaluated or endorsed by the Axe
...
leon.white@docs.axerunners.com

In addition to joining a pool, you will also need to create a Axe
address to receive your payout. To do this in Axe Core wallet, see
:ref:`here <axecore-send-receive>`.
...
This documentation describes how to mine Axe under the Windows
...
- `Axe Forum Mining Discussions <https://www.axerunners.com/forum/topic/mining.3/>`_
...
.. figure:: img/cpu-miner-files.png
   ...
   Executable CPU miners for Axe

Configuration
-------------

Begin by selecting a mining pool and generating a Axe address as
...
- a = algorithm, which is X11 for Axe
- o = URL of your mining pool, including the protocol and port
- u = username, usually the Axe receiving address of your wallet or worker
...
processor on your graphics card) to mine Axe using the X11 algorithm on
...
- user = username, usually the Axe receiving address of your wallet or
  worker
...
.. figure:: img/gpu-config.png
   ...
   Configuration file for a Axe GPU miner
...
Axe. You are responsible for carrying out your own research and any
...
section of the Axe Forums <https://www.axerunners.com/forum/topic/hardware-discussions-asic-gpu-cpu.101/>`_.
...
+----------------------------------------------------------------------------------------------------------+---------------+---------+---------+-----------------+---------+
| `iBelink DM56G <https://ibelink.co/product/ibelink-dm56g-x11-axe-miner-with-56-gh-s-hash-rate/>`_       | 56 GH/s ±5%   | 2100 W  | 17 kg   | 490 x 390 x 180 | $1,800  |
+----------------------------------------------------------------------------------------------------------+---------------+---------+---------+-----------------+---------+
...
+-------------------------------------------------------------------------------------------------------+----------------+-------+---------+-----------------+
| `iBelink DM22G <https://ibelink.co/product/ibelink-dm22g-x11axe-miner-with-22-ghs-hash-rate/>`_      | 22 GH/s ±5%    | 810 W | 19 kg   | 490 x 350 x 180 |
+-------------------------------------------------------------------------------------------------------+----------------+-------+---------+-----------------+
