...
project = u'Axe'
copyright = u'2018, Axe Core Group, Inc'
author = u'strophy'
...
html_logo = 'img/axe_logo_white.png'
...
latex_documents = [
    (master_doc, 'Axe.tex', u'Axe Documentation',
     u'strophy', 'manual'),
]
...
man_pages = [
    (master_doc, 'axe', u'Axe Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Axe', u'Axe Documentation',
     author, 'Axe', 'A revolutionary digital money system, Axe is Digital Cash',
     'Miscellaneous'),
]
